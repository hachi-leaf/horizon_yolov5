...
if __name__ == '__main__':
    ...
    # yaml文件位置
    parser.add_argument('--cfg', type=str, default='models\yolov5s_dmn_new.yaml', help='model.yaml path')
    # VOC文件位置
    parser.add_argument('--data', type=str, default='data\\voc.yaml', help='data.yaml path')
    # 权重位置
    parser.add_argument('--weights', type=str, default='weights\\yolov5s_2.0.pt', help='initial weights path')
    # 训练轮次
